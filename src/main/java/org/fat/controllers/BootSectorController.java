...
public class BootSectorController {
    ...
    private void initializeTable() {
        ...
        ObservableList<Map<String, Object>> data = FXCollections.observableArrayList(
                ...
                createEntry("Sectors Per Cluster", 13, 1, Integer.toString(this.sector)),
                createEntry("Reserved Sectors", 14, 2, "1"),
                createEntry("FAT's", 16, 1, "1"),
                createEntry("Root Entries", 17, 2, "512/544"),
                createEntry("Sectors", 19, 2, Integer.toString( (this.cluster * this.sector) * 512)),
                createEntry("Media Descriptor", 21, 1, "240"),
                createEntry("Sectors Per FAT", 22, 2, Integer.toString( (this.cluster * 1) / 512)),
                ...
                createEntry("Volume Label", 43, 11, this.VartablaDirectorios.getRoot().toString()),
